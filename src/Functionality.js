...
function ShowCollection(){
    ...
    if (updown == "down"){
        while(index > (CollectionNum - 100)){
            ...
            newcard.innerHTML = img + '<a class="nftID head">Genesis ID:</a>' + '<br>' + '<a class="nftID">' + indexid + '</a>' + '<br>' + '<a class="nftID scout" href="' + BlockscoutLink + '" target="_blank">View On Blockscout</a>';
...
function LoadNFTs() {
    ...
    while(index < ids.length){
        ...
        newcard.innerHTML = img + '<a class="nftID head">Genesis ID:</a>' + '<br>' + '<a class="nftID">' + id + '</a>' + '<br>' + '<a class="nftID scout" href="' + BlockscoutLink + '" target="_blank">View On Blockscout</a>';
