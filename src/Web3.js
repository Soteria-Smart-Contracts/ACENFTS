...
let ids;
let netID;
const contractAddress = "0x7B77F4101121bD7Fbfb1FeD2CEC78d3dDc604e05";
...
async function loginWithEth(){
    if(window.ethereum){
        ...
        if (netID != 61){
            ...
            alert("The current Metamask/Web3 network is not ETC, please connect to the Ethereum Classic network.");
            showOverlay();
